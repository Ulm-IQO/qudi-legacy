...
if __name__ == "__main__":
    ...
    file = r"C:\Software\qudi_data\pulsed_files" + "/" + "rabi_shaped_ch1.bin8"
    file = r"C:\Software\qudi_data\pulsed_files" + "/" + "deer_rabi_ch1.bin8"
    file = r"C:\Software\qudi_data\pulsed_files" + "/" + "deer_ramsey_ch1.bin8"
    file = r"C:\Software\qudi_data\pulsed_files" + "/" + "p1pol_rabi_sweep_ch1.bin8"
    file = r"C:\Software\qudi_data\pulsed_files" + "/" + "p1pol_coupling_sweep_ch1.bin8"
    file = r"C:\Software\qudi_data\pulsed_files" + "/" + "p1pol_ramsey_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "PulsePol_singledrive_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "PulsePol_Ramsey_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "PulsePol_Ramsey_rep_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "pulsepol_sim_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "pulsepol_deerswap_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "pulsedodmr_sam_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "rabi_sam_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "T1_meas_ch1.bin8"
    file = r"C:\Software\qudi_data\pulsed_files" + "/" + "timedeer_multidrive_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "pulsepol_timedeer_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "pulsepol_deerswap_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "pulsedodmr_sam_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "pulsepol_timedeer_truerabi_ch1.bin8"
    file = r"C:\Software\qudi_data\pulsed_files" + "/" + "deer_rabi_ch1.bin8"
    #file = r"C:\Software\qudi_data\pulsed_files" + "/" + "Ramsey_ch1.bin8"
